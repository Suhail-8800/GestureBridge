...
#             # 🔥 NOW EXPECTING 126 FEATURES
#             data = data.reshape(42, 3)  # 2 hands (21+21)

#             # Use first landmark as base
...
# print(f"Number Model Accuracy: {accuracy * 100:.2f}%")

# # ========== SAVE ==========
# joblib.dump(model, "model_numbers_full.pkl")
# joblib.dump(le, "label_encoder_numbers_full.pkl")

# print("Unified number model saved successfully")
